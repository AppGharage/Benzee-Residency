...
class RoomAllocation extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                    ...
                    ->line('We only accept Cash being full payment or half payment of your Rent within 30 days and the remaining half paid within 30 days days of initial payment.')
